...
class JsonConvert {
  ...
  T? asT<T extends Object?>(dynamic value) {
	...
	static M? _fromJsonSingle<M>(Map<String, dynamic> json) {
		...
		if(type == (BaseResponse).toString()){
			return BaseResponse.fromJson(json) as M;
		}
		...
		if(type == (MessageEntity).toString()){
			return MessageEntity.fromJson(json) as M;
		}
  ...
  //list is returned by type
	static M? _getListChildType<M>(List<Map<String, dynamic>> data) {
		...
		if(<UserResponse>[] is M){
			return data.map<UserResponse>((Map<String, dynamic> e) => UserResponse.fromJson(e)).toList() as M;
		}
